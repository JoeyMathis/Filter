const data = [
  ...
  //Dom elemenets reference for rendering and user interaction 
...
//add even listener for the search input to filter the products based on user input
...
const setCategories = () => {
   ...
   const allCats = data.map(item => item.cat); //new array of all categories 
    const categories = [
      "All", //adds all as the first category for displaying all products
...
//create a function to set up a price range filter 
const setPrices = () => {
